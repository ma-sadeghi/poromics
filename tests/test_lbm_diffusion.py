...
def test_tau_lbm_open_space():
    ...
    result = tortuosity_lbm(im, axis=0, n_steps=5000, tol=1e-2)
...
def test_tau_lbm_half_open():
    ...
    im[10:, :, :] = True
    result = tortuosity_lbm(im, axis=1, n_steps=5000, tol=1e-2)
